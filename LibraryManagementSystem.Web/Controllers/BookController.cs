...
namespace LibraryManagementSystem.Web.Controllers
{
    public class BookController : BaseController
    {
        ...
        public async Task<IActionResult> All([FromQuery] AllBooksQueryModel queryModel)
        {
            ...
            if (!this.memoryCache.TryGetValue(cacheKey, out AllBooksFilteredAndPagedServiceModel? cachedData))
            {
                ...
                MemoryCacheEntryOptions cacheOptions = new MemoryCacheEntryOptions()
                    .SetAbsoluteExpiration(TimeSpan.FromSeconds(BooksCacheDurationInSeconds));
            ...
            queryModel.Categories = await categoryService.GetAllCategoriesNamesAsync();
