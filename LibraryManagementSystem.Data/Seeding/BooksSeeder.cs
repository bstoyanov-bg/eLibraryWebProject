        ...
        public async Task SeedAsync(ELibraryDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            IEnumerable<Book> books = new HashSet<Book>
            {
                ...
                new Book
                {
                    ...
                    Publisher = "Colibri",
                    ImageFilePath = "img/Time-Shelter-Image.jpg",
                ...
                new Book
                {
                    ...
                    Publisher = "Colibri",
                    ImageFilePath = "img/The-Physics-of-Sorrow-Image.jpg",
                    AuthorId = Guid.Parse("5992BC8E-87F8-41AF-9EFB-E2C354E4BD3B"),
                ...
                new Book
                {
                    ...
                    Publisher = "Ace",
                    ImageFilePath = "img/Dune-Image.jpg",
                ...
                new Book
                {
                    ...
                    Publisher = "Putnam",
                    ImageFilePath = "img/Children-of-Dune-Image.jpg",
                    AuthorId = Guid.Parse("7A774B0B-D493-4A9D-AB57-CCCEDC6DDCB8"),
                ...
                new Book
                {
                    ...
                    Publisher = "Scribe",
                    ImageFilePath = "img/Shantaram-Image.jpg",
                ...
                new Book
                {
                    ...
                    ImageFilePath = "img/The-Mountain-Shadow-Image.jpg",
                    AuthorId = Guid.Parse("1B019738-D4EA-4D18-84D4-F0C2A7F5AAAF"),
