        ...
        public async Task SeedAsync(ELibraryDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            IEnumerable<Book> books = new HashSet<Book>
            {
                new Book
                {
                    ...
                    ImageFilePath = "img/BookCovers/Brief-Answers-to-the-Big-Questions-Image.png",
                    AuthorId = Guid.Parse("3CF69D33-43D6-4AD9-8569-0C2A897A66C0"),
                    FilePath = "BookFiles/Books/Brief-Answers-to-the-Big-Questions.txt",
                    IsDeleted = false,
                },
                new Book
                {
                    ...
                    ImageFilePath = "img/BookCovers/The-Illustrated-Theory-of-Everything-The-Origin-and-Fate-of-the-Universe-Image.jpg",
                    AuthorId = Guid.Parse("3CF69D33-43D6-4AD9-8569-0C2A897A66C0"),
                    FilePath = "BookFiles/Books/The-Illustrated-Theory-of-Everything-The-Origin-and-Fate-of-the-Universe.txt",
                    IsDeleted = false,
                },
                new Book
                {
                    ...
                    ImageFilePath = "img/BookCovers/Journey-to-the-Center-of-the-Earth-Image.jpg",
                    AuthorId = Guid.Parse("92FB2DF0-9C82-4B71-B1FB-4DE8CA702866"),
                    FilePath = "BookFiles/Books/Journey-to-the-Center-of-the-Earth.txt",
                    IsDeleted = false,
                },
                new Book
                {
                    ...
                    Publisher = "Pierre-Jules Hetzel",
                    ImageFilePath = "img/BookCovers/Twenty-Thousand-Leagues-Under-the-Seas-Image.jpg",
                    AuthorId = Guid.Parse("92FB2DF0-9C82-4B71-B1FB-4DE8CA702866"),
                    FilePath = "BookFiles/Books/Twenty-Thousand-Leagues-Under-the-Seas.txt",
                    IsDeleted = false,
                },
                new Book
                {
                    ...
                    ImageFilePath = "img/BookCovers/Oliver-Twist-Image.jpg",
                    AuthorId = Guid.Parse("1BAAD29E-BB6A-4424-95AE-9DCF01FA6712"),
                    FilePath = "BookFiles/Books/Oliver-Twist.txt",
                    IsDeleted = false,
                },
                new Book
                {
                    ...
                    ImageFilePath = "img/BookCovers/The-Old-Curiosity-Shop-Image.jpg",
                    AuthorId = Guid.Parse("1BAAD29E-BB6A-4424-95AE-9DCF01FA6712"),
                    FilePath = "BookFiles/Books/The-Old-Curiosity-Shop.txt",
                    IsDeleted = false,
                },
                new Book
                {
                    ...
                    Publisher = "Colibri",
                    ImageFilePath = "img/BookCovers/Time-Shelter-Image.jpg",
                    AuthorId = Guid.Parse("5992BC8E-87F8-41AF-9EFB-E2C354E4BD3B"),
                    FilePath = "BookFiles/Books/Time-Shelter.txt",
                    IsDeleted = false,
                },
                new Book
                {
                    ...
                    Publisher = "Colibri",
                    ImageFilePath = "img/BookCovers/The-Physics-of-Sorrow-Image.jpg",
                    AuthorId = Guid.Parse("5992BC8E-87F8-41AF-9EFB-E2C354E4BD3B"),
                    FilePath = "BookFiles/Books/The-Physics-of-Sorrow.txt",
                    IsDeleted = false,
                },
                new Book
                {
                    ...
                    Publisher = "Ace",
                    ImageFilePath = "img/BookCovers/Dune-Image.jpg",
                    AuthorId = Guid.Parse("7A774B0B-D493-4A9D-AB57-CCCEDC6DDCB8"),
                    FilePath = "BookFiles/Books/Dune.txt",
                    IsDeleted = false,
                },
                new Book
                {
                    ...
                    Publisher = "Putnam",
                    ImageFilePath = "img/BookCovers/Children-of-Dune-Image.jpg",
                    AuthorId = Guid.Parse("7A774B0B-D493-4A9D-AB57-CCCEDC6DDCB8"),
                    FilePath = "BookFiles/Books/Children-of-Dune.txt",
                    IsDeleted = false,
                },
                new Book
                {
                    ...
                    Publisher = "Scribe",
                    ImageFilePath = "img/BookCovers/Shantaram-Image.jpg",
                    AuthorId = Guid.Parse("1B019738-D4EA-4D18-84D4-F0C2A7F5AAAF"),
                    FilePath = "BookFiles/Books/Shantaram.txt",
                    IsDeleted = false,
                },
                new Book
                {
                    ...
                    ImageFilePath = "img/BookCovers/The-Mountain-Shadow-Image.jpg",
                    AuthorId = Guid.Parse("1B019738-D4EA-4D18-84D4-F0C2A7F5AAAF"),
                    FilePath = "BookFiles/Books/The-Mountain-Shadow.txt",
                    IsDeleted = false,
                },
            };
